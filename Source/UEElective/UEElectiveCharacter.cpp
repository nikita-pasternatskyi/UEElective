...
AUEElectiveCharacter::AUEElectiveCharacter()
{
...
void AUEElectiveCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AUEElectiveCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
